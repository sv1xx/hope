...
- днд групп
- более удобный ui/ux
- переделать инпут тасков и групп
- поработать над адаптивностью текста в тасках и группах
- добавить кнопки "выполнить всё" "удалить всё" в группах и во всех заметках
- сделать приятный инпут "новая задача"
