...
- более производительно переписать селекторы
- добавить драг энд дроп
- определить тип таски для драг энд дропа
- переписать функцию добавления таски с учётом позиции таски
- написать функцию изменения позиции таски
- написать селектор выводящий массив относительно активно или нет группы с учетом позиции тасок
- соединить логику днд и вышеописанного
- поправить баг с чекбоксом таски
